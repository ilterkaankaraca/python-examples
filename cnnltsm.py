...
Original file is located at
    https://colab.research.google.com/drive/10BlKHPOl8UoVE7GBLx8Q01R3CZebHEpv
"""
...
df= pd.read_csv("/content/drive/My Drive/data/heart-disease-uci/heart.csv")
print(df)

label_encoder=LabelEncoder().fit(df.target)
labels=label_encoder.transform(df.target)
